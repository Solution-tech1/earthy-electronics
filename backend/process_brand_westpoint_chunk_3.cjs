...
const WESTPOINT_OFFICIAL_EXACT_MAP_CHUNK3 = {
  'westpoint9401': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-9401.png',
  'westpoint9501': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-9501.png',
  'westpoint9601': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-9601.png',
  'westpoint9701': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-9701.png',
  'westpoint9801': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-9801.png',
  'westpoint9802': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-9802.png',
  'westpoint9901': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-9901.png',
  'westpointwf1046': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-1046.png',
  'westpointwf1099': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-1099.png',
  'westpointwf2528': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-2528.png'
};
...
async function processWestPointChunk3() {
  ...
  fs.createReadStream(unmatchedCsvPath)
    ...
    .on('end', async () => {
      ...
      for (let idx = 0; idx < chunk3.length; idx++) {
        ...
        for (const [key, url] of Object.entries(WESTPOINT_OFFICIAL_EXACT_MAP_CHUNK3)) {
      ...
      console.log("==================================================");
      console.log("📊 BRAND 7 (WESTPOINT) — CHUNK 3 COMPLETION REPORT");
...
processWestPointChunk3().catch(console.error);
