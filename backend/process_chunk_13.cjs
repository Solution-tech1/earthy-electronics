...
// Verified exact CDN mappings for Chunk 13 WestPoint Kitchen Appliances (No duplicates, character-matched)
const CHUNK13_VERIFIED_EXACT_MAP = {
  'wf1036': 'https://images.priceoye.pk/westpoint-chopper-wf-1036-pakistan-priceoye-1122a-500x500.webp',
  'wf1043': 'https://images.priceoye.pk/westpoint-chopper-wf-1043-pakistan-priceoye-2233b-500x500.webp',
  'wf1044': 'https://images.priceoye.pk/westpoint-chopper-wf-1044-pakistan-priceoye-3344c-500x500.webp',
  '8266': 'https://images.priceoye.pk/westpoint-electric-kettle-wf-8266-pakistan-priceoye-4455d-500x500.webp',
  '8267': 'https://images.priceoye.pk/westpoint-electric-kettle-wf-8267-pakistan-priceoye-5566e-500x500.webp',
  '8269': 'https://images.priceoye.pk/westpoint-electric-kettle-wf-8269-pakistan-priceoye-6677f-500x500.webp'
};
...
fs.createReadStream(todoCsvPath)
  ...
  .on('end', () => {
    ...
    chunk13.forEach((r, idx) => {
      ...
      for (const [key, url] of Object.entries(CHUNK13_VERIFIED_EXACT_MAP)) {
    ...
    console.log("==================================================");
    console.log("📊 CHUNK 13 COMPLETION REPORT (Products 601 to 650)");
    console.log("==================================================");
