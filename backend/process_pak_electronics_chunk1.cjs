...
async function processPakChunk1() {
  console.log("==================================================");
  console.log("🚀 PROCESSING REFRIGERATORS CHUNK 1 (50 PRODUCTS) FROM PAK-ELECTRONICS.PK");
  console.log("🌐 Portal Scrolled: https://pak-electronics.pk/");
  console.log("==================================================");
  ...
  // Scrape live items from pak-electronics.pk search & categories
  ...
  const scrapedItems = [];
  const targetUrls = [
    'https://pak-electronics.pk/?s=Haier+refrigerator&post_type=product',
    'https://pak-electronics.pk/?s=HRF&post_type=product',
  ...
  // Load Refrigerator Chunk 1 items
  ...
  for (let idx = 0; idx < chunk1.length; idx++) {
    ...
    // Matching rule: Dash/Space/Slash differences allowed! Core base digits MUST match 100%!
...
processPakChunk1().catch(console.error);
