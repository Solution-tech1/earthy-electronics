...
const WESTPOINT_OFFICIAL_EXACT_MAP_CHUNK4 = {
  'westpointwf271': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-271.png',
  'westpointwf281': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-281.png',
  'westpointwf291': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-291.png',
  'westpointwf3469': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-3469.png',
  'westpointwf3569': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-3569.png',
  'westpointwf4500': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-4500.png',
  'westpointwf5146': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-5146.png',
  'westpointwf545': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-545.png',
  'westpointwf555': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-555.png',
  'westpointwf6300': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-6300.png',
  'westpointwf636': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-636.png',
  'westpointwf671': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-671.png',
  'westpointwf832': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-832.png',
  'westpointwff09': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-f09.png'
};
...
async function processWestPointChunk4() {
  ...
  fs.createReadStream(unmatchedCsvPath)
    ...
    .on('end', async () => {
      ...
      for (let idx = 0; idx < chunk4.length; idx++) {
        ...
        for (const [key, url] of Object.entries(WESTPOINT_OFFICIAL_EXACT_MAP_CHUNK4)) {
      ...
      console.log("==================================================");
      console.log("📊 BRAND 7 (WESTPOINT) — CHUNK 4 COMPLETION REPORT");
...
processWestPointChunk4().catch(console.error);
