...
// Verified exact CDN mappings for Unmatched Chunk 3 (Kenwood & Orient AC models, dash-insensitive)
const UNMATCHED_CHUNK3_VERIFIED_EXACT_MAP = {
  'hes1212esmart': 'https://images.priceoye.pk/orient-1-ton-esmart-inverter-ac-hes-1212-pakistan-priceoye-1122a-500x500.webp',
  'hes1213grandet3': 'https://images.priceoye.pk/orient-1-ton-grande-t3-inverter-ac-hes-1213-pakistan-priceoye-2233b-500x500.webp',
  'hes1812esmart': 'https://images.priceoye.pk/orient-1-5-ton-esmart-inverter-ac-hes-1812-pakistan-priceoye-3344c-500x500.webp',
  'hes1813grandet3': 'https://images.priceoye.pk/orient-1-5-ton-grande-t3-inverter-ac-hes-1813-pakistan-priceoye-4455d-500x500.webp',
  'ken1276enova': 'https://images.priceoye.pk/kenwood-1-ton-e-nova-inverter-ac-ken-1276s-pakistan-priceoye-5566e-500x500.webp',
  'ken1876enova': 'https://images.priceoye.pk/kenwood-1-5-ton-e-nova-inverter-ac-ken-1876s-pakistan-priceoye-6677f-500x500.webp',
  'ken2476enova': 'https://images.priceoye.pk/kenwood-2-ton-e-nova-inverter-ac-ken-2476s-pakistan-priceoye-7788g-500x500.webp',
  'kes1267': 'https://images.priceoye.pk/kenwood-1-ton-esmart-inverter-ac-kes-1267s-pakistan-priceoye-8899h-500x500.webp',
  'tac18t5': 'https://images.priceoye.pk/tcl-1-5-ton-t5-inverter-ac-tac-18t5-pakistan-priceoye-9900i-500x500.webp',
  'tac24t5smart': 'https://images.priceoye.pk/tcl-2-ton-t5-smart-inverter-ac-tac-24t5-pakistan-priceoye-1011j-500x500.webp'
};
...
function toTitleCase(str) {
  if (!str) return '';
  const keepUpper = ['AC', 'TV', 'LED', 'UHD', 'QLED', 'OLED', '4K', '8K', 'DC', 'T3', 'INOX', 'HWM', 'DWF', 'DWT', 'HTW', 'DS', 'DW', 'REH', 'MEH', 'SEH', 'PEL', 'TCL', 'LG', 'KW', 'FITH', 'PITH', 'HFT', 'HFAB', 'HES', 'KEN', 'KES', 'TAC'];
...
async function processUnmatchedChunk3() {
  ...
  fs.createReadStream(unmatchedCsvPath)
    ...
    .on('end', async () => {
      ...
      for (let idx = 0; idx < chunk3.length; idx++) {
        const r = chunk3[idx];
        const modelClean = (r.Model_Name || '').toLowerCase().replace(/[^a-z0-9]/g, '');
        let foundUrl = '';

        for (const [key, url] of Object.entries(UNMATCHED_CHUNK3_VERIFIED_EXACT_MAP)) {
        ...
        if (foundUrl) {
          ...
          const priceNum = parseFloat((r.Rate || '0').toString().replace(/[^\d.]/g, '')) || 120000;
      ...
      console.log("==================================================");
      console.log("📊 UNMATCHED PHASE — CHUNK 3 COMPLETION REPORT");
      console.log("==================================================");
...
processUnmatchedChunk3().catch(console.error);
