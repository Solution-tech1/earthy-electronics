...
const WESTPOINT_OFFICIAL_EXACT_MAP_CHUNK1 = {
  'westpoint1201': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-1201.png',
  'westpoint1203': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-1203.png',
  'westpoint1853': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-1853.png',
  'westpoint2804': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-2804.png',
  'westpoint2805': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-2805.png',
  'westpoint3118': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-3118.png',
  'westpoint368': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-368.png',
  'westpoint409': 'https://www.westpoint.pk/media/catalog/product/w/f/wf-409.png'
};
...
async function processWestPointChunk1() {
  ...
  fs.createReadStream(unmatchedCsvPath)
    ...
    .on('end', async () => {
      ...
      for (let idx = 0; idx < chunk1.length; idx++) {
        ...
        for (const [key, url] of Object.entries(WESTPOINT_OFFICIAL_EXACT_MAP_CHUNK1)) {
      ...
      console.log("==================================================");
      console.log("📊 BRAND 7 (WESTPOINT) — CHUNK 1 COMPLETION REPORT");
...
processWestPointChunk1().catch(console.error);
