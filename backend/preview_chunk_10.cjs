...
fs.createReadStream(todoCsvPath)
  ...
  .on('end', () => {
    ...
    console.log("=== CHUNK 10 (PRODUCTS 451 TO 500) PREVIEW ===");
    console.log(`Total in Chunk 10: ${chunk10.length} products\n`);

    chunk10.forEach((r, idx) => {
      console.log(`${idx + 451}. [${r.Brand}] ${r.Model_Name} | Category: ${r.Category} | Rate: Rs. ${r.Rate || 'N/A'}`);
    });
