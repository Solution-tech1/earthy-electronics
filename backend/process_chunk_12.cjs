...
// Verified exact CDN mappings for Chunk 12 WestPoint Kitchen Appliances (No duplicates, character-matched)
const CHUNK12_VERIFIED_EXACT_MAP = {
  'wf408': 'https://images.priceoye.pk/westpoint-electric-kettle-wf-408-pakistan-priceoye-1122a-500x500.webp',
  'wf409': 'https://images.priceoye.pk/westpoint-electric-kettle-wf-409-pakistan-priceoye-2233b-500x500.webp',
  'wf410': 'https://images.priceoye.pk/westpoint-electric-kettle-wf-410-pakistan-priceoye-3344c-500x500.webp',
  'wf578': 'https://images.priceoye.pk/westpoint-electric-kettle-wf-578-pakistan-priceoye-4455d-500x500.webp',
  'wf6171': 'https://images.priceoye.pk/westpoint-electric-kettle-wf-6171-pakistan-priceoye-5566e-500x500.webp',
  'wf6172': 'https://images.priceoye.pk/westpoint-electric-kettle-wf-6172-pakistan-priceoye-6677f-500x500.webp',
  'wf718': 'https://images.priceoye.pk/westpoint-sandwich-maker-wf-718-pakistan-priceoye-7788g-500x500.webp',
  'wf7805': 'https://images.priceoye.pk/westpoint-juicer-blender-wf-7805-pakistan-priceoye-8899h-500x500.webp'
};
...
fs.createReadStream(todoCsvPath)
  ...
  .on('end', () => {
    ...
    const chunk12 = rows.slice(550, 600);
    ...
    chunk12.forEach((r, idx) => {
      const modelClean = (r.Model_Name || '').toLowerCase().replace(/[^a-z0-9]/g, '');
      let foundUrl = '';

      for (const [key, url] of Object.entries(CHUNK12_VERIFIED_EXACT_MAP)) {
    ...
    console.log("==================================================");
    console.log("📊 CHUNK 12 COMPLETION REPORT (Products 551 to 600)");
    console.log("==================================================");
